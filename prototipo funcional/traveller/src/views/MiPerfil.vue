    ...
    <div class="container-profile">
      ...
      <div class="data-profile">
        <div v-if="!mobile" class="pc-profile">
          ...
          <div class="remove-btns">
            <div class="remove-history">
              <v-btn block elevation="4" x-large color="black"
                ><span class="span_white">Eliminar historial</span></v-btn
              >
            </div>
            <div class="remove-account">
              <v-btn block elevation="4" x-large color="black"
                ><span class="span_white">Eliminar cuenta</span></v-btn
              >
            </div>
          </div>
        </div>
        <div v-if="mobile" class="scroll-profile">
          ...
          <v-row justify="center"><p class="datos">{{usuario.passwd}}</p></v-row>
          <v-row justify="center"
